...
function Login() {
  ...
  return (
    ...
    >
      <div className="w-full md:w-3/4 mx-auto my-auto flex flex-col justify-center px-6 py-12 lg:px-20">
        <img src={logo} alt="Logo" width="400px" className="mb-6 self-center" />

        <h2 className="text-2xl md:text-3xl font-bold text-[#3fc7f3] mb-1 text-center md:text-right">
          تسجيل الدخول 📇
        </h2>
