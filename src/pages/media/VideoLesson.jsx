...
function VideoLesson() {
  ...
  return (
    <div
      id="video1"
      className="content-section w-full flex flex-col items-center justify-center"
    >
      <h2 className="text-3xl font-bold mb-10 text-center">فيديو الشرح</h2>
      ...
      <div className="flex justify-center mt-9">
        <button
          onClick={() => navigate("/media/homework")}
