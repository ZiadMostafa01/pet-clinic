...
function Subscriptions() {
  return (
    <div className="my-10">
      <div className="flex justify-center items-center gap-2 mt-20 p-10">
        <svg
        ...
        <span className="text-2xl">انت غير مشترك بأي كورس حتي الآن!</span>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:p-6 sm:mx-[2vw] md:mx-[5vw] lg:mx-[0vw] xl:mx-[5vw]">
        <div className="group transform transition-transform duration-300">
          ...
          <div className="bg-white rounded-md shadow-md hover:shadow-2xl border-2 border-cyan-500 -mt-6 mx-4 md:p-4 z-10 relative py-8 group-hover:scale-[1.02] transition duration-500">
            <div className="p-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="px-4 py-2 text-sm border border-cyan-400 bg-cyan-50 text-cyan-500 rounded-md text-center">
                  انت مشترك
                  <br />
                  في هذا الكورس
                </div>
